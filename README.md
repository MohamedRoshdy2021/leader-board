...
> this is Leader Board project we have created using HTML, CSS, Javascript, linters , webpack
...
```sh
  cd my-folder
  git clone https://github.com/MohamedRoshdy2021/leader-board
...
- i will test the app with jest
- going to use web api's in the next feature's
